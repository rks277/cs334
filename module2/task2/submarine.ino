...
void loop() {
    ...
    if (off) {Serial.print("1");} else {Serial.print("0");}; Serial.print(",");
    if (ended) {Serial.println("1");} else {Serial.println("0");};
...
void initGame() {
    ...
    // Treasure coords
    game_tX = int(random(-70, 70));
    game_tY = int(random(-70, 70));
    game_tZ = int(random(0, 3));
}
